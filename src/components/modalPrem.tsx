...
const ExampleWrapper = () => {
  ...
  const [hasAdulisProSubscribed, setHasAdulisProSubscribed] = useState(false); // 

  useEffect(() => {
    const adulisProSubscribed = Cookies.get(' '); // Specific cookie name
...
const AdulisProModal = ({
  ...
  const handleSubmit = async () => {
    ...
    Cookies.set(' ', 'true', { expires: 365 }); // Specific cookie name
